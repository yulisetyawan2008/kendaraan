                        ...
                        <form role="form" action="/pegawai/{{$pegawai->id}}" method="POST">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                                ...
                                                <select class="custom-select" id="jenisID" name="jenisID">
                                                    <option value="{{$pegawai->jenisID}}" selected>{{$pegawai->jenisID}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="noID" name = "noID" value="{{$pegawai->noID}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <div class="input-group mb-3">
                                                ...
                                                <select class="custom-select" id="jenisKelamin" name="jenisKelamin">
                                                    <option value="{{$pegawai->jenisKelamin}}" selected>{{$pegawai->jenisKelamin}}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <select class="custom-select" id="pangkatGol" name="pangkatGol">
                                                <option value="{{$pegawai->pangkatGol}}" selected>{{$pegawai->pangkatGol}}</option>
                                    ...
                                    <input hidden name="created_at" value="{{$pegawai->created_at}}">
